...
public class CadastroEnfermeiros extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroEnfermeiros frame = new CadastroEnfermeiros();
	...
	public CadastroEnfermeiros() {
		...
		JLabel labelNomeTela = new JLabel("Cadastro de Enfermeiro:");
		labelNomeTela.setFont(new Font("Tahoma", Font.PLAIN, 18));
		labelNomeTela.setBounds(200, 11, 200, 20);
		...
		labelCOREN.setBounds(10, 215, 60, 15);
		contentPane.add(labelCOREN);
		...
		campoCoren.setBounds(70, 212, 137, 20);
		contentPane.add(campoCoren);
		campoCoren.setColumns(10);
