...
public class CadastroMedicos extends JFrame {
	...
	private JLabel labelEspecializacao;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroMedicos frame = new CadastroMedicos();
	...
	public CadastroMedicos() {
		...
		JLabel labelNomeTela = new JLabel("Cadastro de Médico:");
		labelNomeTela.setFont(new Font("Tahoma", Font.PLAIN, 18));
		labelNomeTela.setBounds(215, 11, 170, 20);
		...
		labelCRM.setBounds(10, 215, 60, 15);
		contentPane.add(labelCRM);
		
		labelEspecializacao = new JLabel("Especialização:");
		labelEspecializacao.setBounds(10, 242, 90, 15);
		contentPane.add(labelEspecializacao);
		...
		campoEspecializacao.setBounds(100, 239, 262, 20);
		contentPane.add(campoEspecializacao);
		campoEspecializacao.setColumns(10);
