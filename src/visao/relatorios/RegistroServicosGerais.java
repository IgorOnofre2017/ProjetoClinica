...
public class RegistroServicosGerais extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroServicosGerais frame = new RegistroServicosGerais();
	...
	public RegistroServicosGerais() {
		...
		JLabel labelNomeTela = new JLabel("Registro dos Serviços Gerais:");
