...
public class RegistroMedicos extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroMedicos frame = new RegistroMedicos();
	...
	public RegistroMedicos() {
		...
		JLabel labelNomeTela = new JLabel("Registro dos Médicos:");
		labelNomeTela.setFont(new Font("Tahoma", Font.PLAIN, 18));
		labelNomeTela.setBounds(210, 11, 180, 20);
